...
import com.example.kumkangreader.Adapter.ViewStockOutAdapter;
...
public class ActivityViewStockOut extends BaseActivity{
    TextView txtContent;
    TextView txtDate;
    int tyear;
    int tmonth;
    ...
    ViewStockOutAdapter viewStockOutAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_stockout);
    ...
    public void getViewStockOut(String fromDate) {
        String url = getString(R.string.service_address) + "getViewStockOut";
        ContentValues values = new ContentValues();
        values.put("BusinessClassCode", 2);
        values.put("FromDate", fromDate);
        GetViewStockOut gsod = new GetViewStockOut(url, values);
        gsod.execute();
    }

    public class GetViewStockOut extends AsyncTask<Void, Void, String> {
        String url;
        ContentValues values;

        GetViewStockOut(String url, ContentValues values) {
            this.url = url;
            this.values = values;
        }
            ...
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    if (!child.getString("ErrorCheck").equals("null")) {//문제가 있을 시, 에러 메시지 호출 후 종료
                        ...
                        showErrorDialog(ActivityViewStockOut.this, ErrorCheck,2);
                        return;
                    }
                ...
                viewStockOutAdapter= new ViewStockOutAdapter
                        (ActivityViewStockOut.this, R.layout.listview_view_stockout_row, viewDataArrayList);
                listviewCoil.setAdapter(viewStockOutAdapter);
                progressOFF();
            } catch (Exception e) {
                e.printStackTrace();
