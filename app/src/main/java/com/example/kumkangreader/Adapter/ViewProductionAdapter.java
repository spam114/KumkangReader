...
public class ViewProductionAdapter extends ArrayAdapter<ViewData> implements BaseActivityInterface {
   ...
   /* String lastPart;//마지막에 추가된 품목,규격
    ...
    public ViewProductionAdapter(Context context, int layoutResourceID, ArrayList data) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (item != null) {
            ...
            TextView txtCostCenterName = (TextView) row.findViewById(R.id.txtCostCenterName);
            txtCostCenterName.setText(((ViewData) data.get(position)).CostCenterName);

            TextView txtCommodityName = (TextView) row.findViewById(R.id.txtCommodityName);
            txtCommodityName.setText(((ViewData) data.get(position)).CommodityName);
