...
public class ProductionStockAdapter extends ArrayAdapter<Stock> implements BaseActivityInterface {
   ...
   /* String lastPart;//마지막에 추가된 품목,규격
    ...
    public ProductionStockAdapter(Context context, int layoutResourceID, ArrayList data) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (item != null) {
            ...
            txtPartSpecName.setText(((Stock) data.get(position)).PartSpecName);
