...
public class ViewStockOutAdapter extends ArrayAdapter<ViewData> implements BaseActivityInterface {
   ...
   /* String lastPart;//마지막에 추가된 품목,규격
    ...
    public ViewStockOutAdapter(Context context, int layoutResourceID, ArrayList data) {
